...
export default function ClientTaskyInfoPage() {
  useAuthGuard();
      ...
      <main className={`${spacing.container} py-8 max-w-2xl`}>
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className={`text-sm ${colors.text.secondary}`}>
              Notifications sur l'état de vos demandes et prestations
            </p>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className={`bg-white rounded-2xl p-12 text-center border ${colors.border.light}`}>
            ...
            <p className={`text-sm ${colors.text.secondary}`}>
              Vous serez informé ici des événements importants de vos demandes.
            </p>
          </div>
        ) : (
