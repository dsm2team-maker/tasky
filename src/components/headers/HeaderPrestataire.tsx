      ...
      <div className={spacing.container}>
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className={`hidden md:block text-sm font-medium ${colors.premium.text} hover:${colors.secondary.text} transition-colors`}
            >
              Déconnexion
            </button>
            <button
              ...
              className={`md:hidden p-2 -mr-2 ${colors.premium.text} hover:${colors.secondary.text} transition-colors`}
        ...
        {mobileOpen && (
          <div className="md:hidden pb-4 pt-2 border-t border-gray-200 mt-2 flex flex-col gap-4">
            ...
            <button
              onClick={handleLogout}
              className={`text-left text-sm font-medium ${colors.premium.text} hover:${colors.secondary.text} transition-colors`}
            >
              Déconnexion
            </button>
          </div>
